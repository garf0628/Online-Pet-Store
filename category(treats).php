        ...
        <div class="container">
            <div id="categoryside_nav">
                ...
                <ul>
                    ...
                    <li><a class="active" href="category(treats).php?petcategory=<?php echo $category?>">Treats</a></li>
                    <li><a href="category(othersupplies).php?petcategory=<?php echo $category?>">Other Supplies</a></li>
                </ul>
            </div>
            <div id="categorycontent">
                <?php
                    include("conn.php");
                    $result=mysqli_query($conn, "SELECT * FROM product WHERE Pet_Category='$category' AND Type='Treats'");
