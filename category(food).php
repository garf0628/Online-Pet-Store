        ...
        <div class="container">
            <div id="categoryside_nav">
                ...
                <ul>
                    ...
                    <li><a class="active" href="category(food).php?petcategory=<?php echo $category?>">Food</a></li>
            ...
            <div id="categorycontent">
                <?php
                    include("conn.php");
                    $result=mysqli_query($conn, "SELECT * FROM product WHERE Pet_Category='$category' AND Type='Food'");
